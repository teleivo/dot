	...
	tests := map[string]struct {
			...
			want: []token.Token{
				{
					...
					To:   token.Position{Row: 1, Column: 1},
				},
				{
					Type: token.RightBrace, Literal: "}",
					From: token.Position{Row: 1, Column: 2},
					To:   token.Position{Row: 1, Column: 2},
				},
				{
					Type: token.Semicolon, Literal: ";",
					From: token.Position{Row: 1, Column: 3},
					To:   token.Position{Row: 1, Column: 3},
				},
				{
					Type: token.Equal, Literal: "=",
					From: token.Position{Row: 1, Column: 4},
					To:   token.Position{Row: 1, Column: 4},
				},
				{
					Type: token.LeftBracket, Literal: "[",
					From: token.Position{Row: 1, Column: 5},
					To:   token.Position{Row: 1, Column: 5},
				},
				{
					Type: token.RightBracket, Literal: "]",
					From: token.Position{Row: 1, Column: 6},
					To:   token.Position{Row: 1, Column: 6},
				},
				{
					Type: token.Comma, Literal: ",",
					From: token.Position{Row: 1, Column: 7},
					To:   token.Position{Row: 1, Column: 7},
				},
				{
					Type: token.Colon, Literal: ":",
					From: token.Position{Row: 1, Column: 8},
					To:   token.Position{Row: 1, Column: 8},
				},
				{Type: token.EOF},
			},
		},
		...
		"AttributeList": {
			...
			want: []token.Token{
				...
				{
					Type: token.Equal, Literal: "=",
					From: token.Position{Row: 2, Column: 14},
					To:   token.Position{Row: 2, Column: 14},
				},
				{Type: token.Identifier, Literal: "t"},
				{Type: token.Identifier, Literal: "fontname"},
				{
					Type: token.Equal, Literal: "=",
					From: token.Position{Row: 3, Column: 14},
					To:   token.Position{Row: 3, Column: 14},
				},
				{Type: token.Identifier, Literal: `"Helvetica,Arial,sans-serif"`},
				{
					Type: token.Comma, Literal: ",",
					From: token.Position{Row: 3, Column: 44},
					To:   token.Position{Row: 3, Column: 44},
				},
				{Type: token.Identifier, Literal: "fontsize"},
				{
					Type: token.Equal, Literal: "=",
					From: token.Position{Row: 3, Column: 53},
					To:   token.Position{Row: 3, Column: 53},
				},
				{Type: token.Identifier, Literal: "16"},
				{
					Type: token.RightBracket, Literal: "]",
					From: token.Position{Row: 4, Column: 4},
					To:   token.Position{Row: 4, Column: 4},
				},
				{Type: token.Edge, Literal: "edge"},
				{
					Type: token.LeftBracket, Literal: "[",
					From: token.Position{Row: 5, Column: 11},
					To:   token.Position{Row: 5, Column: 11},
				},
				{Type: token.Identifier, Literal: "arrowhead"},
				{
					Type: token.Equal, Literal: "=",
					From: token.Position{Row: 5, Column: 21},
					To:   token.Position{Row: 5, Column: 21},
				},
				{Type: token.Identifier, Literal: "none"},
				{Type: token.Identifier, Literal: "color"},
				{
					Type: token.Equal, Literal: "=",
					From: token.Position{Row: 5, Column: 32},
					To:   token.Position{Row: 5, Column: 32},
				},
				{Type: token.Identifier, Literal: `"#00008844"`},
				{
					Type: token.Comma, Literal: ",",
					From: token.Position{Row: 5, Column: 44},
					To:   token.Position{Row: 5, Column: 44},
				},
				{Type: token.Identifier, Literal: "style"},
				{
					Type: token.Equal, Literal: "=",
					From: token.Position{Row: 5, Column: 51},
					To:   token.Position{Row: 5, Column: 51},
				},
				{Type: token.Identifier, Literal: "filled"},
				{
					Type: token.RightBracket, Literal: "]",
					From: token.Position{Row: 5, Column: 59},
					To:   token.Position{Row: 5, Column: 59},
				},
				{
					Type: token.Semicolon, Literal: ";",
					From: token.Position{Row: 5, Column: 60},
					To:   token.Position{Row: 5, Column: 60},
				},
				{Type: token.EOF},
			},
		},
		"Subgraphs": {
			...
			want: []token.Token{
				...
				{
					Type: token.RightBrace, Literal: "}",
					From: token.Position{Row: 1, Column: 12},
					To:   token.Position{Row: 1, Column: 12},
				},
				...
				{
					Type: token.LeftBrace, Literal: "{",
					From: token.Position{Row: 3, Column: 13},
					To:   token.Position{Row: 3, Column: 13},
				},
				...
				{
					Type: token.Semicolon, Literal: ";",
					From: token.Position{Row: 5, Column: 17},
					To:   token.Position{Row: 5, Column: 17},
				},
				{Type: token.Identifier, Literal: "A"},
				{
					Type: token.Semicolon, Literal: ";",
					From: token.Position{Row: 5, Column: 20},
					To:   token.Position{Row: 5, Column: 20},
				},
				{Type: token.Identifier, Literal: "B"},
				{
					Type: token.Semicolon, Literal: ";",
					From: token.Position{Row: 5, Column: 22},
					To:   token.Position{Row: 5, Column: 22},
				},
				{Type: token.Identifier, Literal: "C"},
				{
					Type: token.Semicolon, Literal: ";",
					From: token.Position{Row: 5, Column: 24},
					To:   token.Position{Row: 5, Column: 24},
				},
				{
					Type: token.RightBrace, Literal: "}",
					From: token.Position{Row: 6, Column: 4},
					To:   token.Position{Row: 6, Column: 4},
				},
				{Type: token.EOF},
			},
		},
