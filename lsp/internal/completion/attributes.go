...
var attrTypeInfo = [...]struct {
	...
	TypeBool:      {"bool", []string{"true", "false", "yes", "no"}, "Boolean value"},
...
var Attributes = func() []Attribute {
	attributes := []Attribute{
		...
		{Name: "beautify", Type: TypeBool, UsedBy: Graph, Documentation: "Whether to draw leaf nodes in circle around root (sfdp)"},
		{Name: "bgcolor", UsedBy: Graph | Cluster, Documentation: "Canvas background color"},
		{Name: "center", Type: TypeBool, UsedBy: Graph, Documentation: "Whether to center drawing in output canvas"},
		...
		{Name: "cluster", Type: TypeBool, UsedBy: Cluster | Subgraph, Documentation: "Whether subgraph is a cluster"},
		...
		{Name: "compound", Type: TypeBool, UsedBy: Graph, Documentation: "Allow edges between clusters (dot layout)"},
		{Name: "concentrate", Type: TypeBool, UsedBy: Graph, Documentation: "Use edge concentrators"},
		{Name: "constraint", Type: TypeBool, UsedBy: Edge, Documentation: "Whether edge used in node ranking (dot layout)"},
		{Name: "Damping", UsedBy: Graph, Documentation: "Factor damping force motions (neato layout)"},
		{Name: "decorate", Type: TypeBool, UsedBy: Edge, Documentation: "Connect edge label to edge with line"},
		...
		{Name: "fixedsize", Type: TypeBool, UsedBy: Node, Documentation: "Use specified width/height for node size"},
		...
		{Name: "forcelabels", Type: TypeBool, UsedBy: Graph, Documentation: "Force placement of all xlabels"},
		...
		{Name: "headclip", Type: TypeBool, UsedBy: Edge, Documentation: "Clip edge head to node boundary"},
		...
		{Name: "labelfloat", Type: TypeBool, UsedBy: Edge, Documentation: "Allow edge labels less constrained in position"},
		...
		{Name: "landscape", Type: TypeBool, UsedBy: Graph, Documentation: "Render graph in landscape mode"},
		...
		{Name: "newrank", Type: TypeBool, UsedBy: Graph, Documentation: "Use single global ranking, ignoring clusters (dot)"},
		{Name: "nodesep", UsedBy: Graph, Documentation: "Minimum space between adjacent nodes"},
		{Name: "nojustify", Type: TypeBool, UsedBy: Graph | Cluster | Node | Edge, Documentation: "Justify multiline text vs previous line"},
		{Name: "normalize", UsedBy: Graph, Documentation: "Normalize final layout coordinates"},
		{Name: "notranslate", Type: TypeBool, UsedBy: Graph, Documentation: "Avoid translating layout to origin (neato)"},
		...
		{Name: "oneblock", Type: TypeBool, UsedBy: Graph, Documentation: "Draw circo graphs around one circle"},
		...
		{Name: "overlap_shrink", Type: TypeBool, UsedBy: Graph, Documentation: "Compress pass for overlap removal"},
		{Name: "pack", Type: TypeBool, UsedBy: Graph, Documentation: "Layout components separately then pack"},
		...
		{Name: "pin", Type: TypeBool, UsedBy: Node, Documentation: "Keep node at input position (neato, fdp)"},
		...
		{Name: "regular", Type: TypeBool, UsedBy: Node, Documentation: "Force polygon to be regular"},
		{Name: "remincross", Type: TypeBool, UsedBy: Graph, Documentation: "Run edge crossing minimization twice (dot)"},
		...
		{Name: "tailclip", Type: TypeBool, UsedBy: Edge, Documentation: "Clip edge tail to node boundary"},
		...
		{Name: "truecolor", Type: TypeBool, UsedBy: Graph, Documentation: "Use truecolor or palette for bitmap rendering"},
